...
export default function EditApplication({ app }: EditApplicationProps) {
    ...
    <div className="font-jakarta flex flex-col relative h-full w-full max-w-160 rounded-xl border border-outline-variant/10 bg-surface-container text-on-background">
      ...
      <div className="flex justify-between items-center p-8 border-b border-outline-variant/10">
        <div className="flex flex-col gap-2">
          ...
          <h2>Make changes to your existing application.</h2>
        </div>
        <div
          onClick={() => modal.hide()}
        ...
        <div className="flex w-full flex-col gap-3">
          ...
          <div className="flex w-full items-center justify-center">
            <div className="max-w-70">
              <Rating editable={true} rating={app.rating} onChange={(e) => setApplication(prev => prev ? { ...prev, rating: e } : prev)} />
            </div>
          </div>
        </div>
        {/** Employment type */}
