        ...
        <div className="flex flex-col font-jakarta w-full h-full items-center justify-center mb-10 space-y-4">
            ...
            <div className="glass-panel w-full max-w-md rounded-xl p-8 md:p-10 shadow-xl relative overflow-hidden bg-surface-container-low border-outline-variant/30">
                ...
                <form 
                    ...
                    <button 
                        className="flex w-full rounded-lg py-3 px-4 justify-center items-center gap-2 font-semibold bg-primary-container hover:bg-primary text-on-primary-container transition-colors"
                        type="submit">
                        Create Account
                ...
                <button 
                    ...
                    className="w-full font-semibold text-lg rounded-lg py-3 px-4 border border-outline-variant/50 flex justify-center items-center gap-2 mt-5 hover:bg-surface-container-lowest transition-colors duration-300">
