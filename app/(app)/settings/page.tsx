                ...
                <div className="flex gap-3">
                    <div className="flex gap-3">
                        {userProfile?.user_metadata.picture != undefined ?
                            <img className="w-30 h-30 rounded-2xl" src={userProfile.user_metadata.picture} alt="User profile picture" />
                            :
                            <div className="flex w-30 h-30 items-center justify-center bg-surface-container-high rounded-2xl">
                                <svg xmlns="http://www.w3.org/2000/svg" height="72px" viewBox="0 -960 960 960" width="72px" fill="currentColor"><path d="M367-527q-47-47-47-113t47-113q47-47 113-47t113 47q47 47 47 113t-47 113q-47 47-113 47t-113-47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm296.5-343.5Q560-607 560-640t-23.5-56.5Q513-720 480-720t-56.5 23.5Q400-673 400-640t23.5 56.5Q447-560 480-560t56.5-23.5ZM480-640Zm0 400Z"/>
                                </svg>
                            </div>
                        }
                    </div>
                    ...
                    <div className="flex p-5 bg-surface-container rounded-xl border border-surface-container-highest justify-between">
                        <div className="flex gap-3">
                            <div className="flex h-fit items-center justify-center p-1 bg-primary-container/50 text-primary rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="currentColor"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z"/>
                                </svg>
                            </div>
                            <div className="flex flex-col gap-2">
                        ...
                        <div className="flex h-full items-center justify-center">
                            <ToggleButton disabled={loading} status={gmailToken != null} onChange={(a) => handleChange(a)} />
                        </div>
                    </div>
                </div>
