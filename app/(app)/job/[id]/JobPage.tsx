  ...
  return (
    <div className="flex flex-col w-full h-full font-jakarta py-10 px-5 md:px-15 gap-10 bg-background text-on-background">
      ...
      <div className="flex md:flex-row flex-col gap-5 items-start justify-start">
        {/** Left side */}
        <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop flex flex-col w-full">
          {/** Notes */}
          ...
          {/** Job description */}
          <div className="mt-5 lg:col-span-8 flex flex-col h-fit bg-surface-container-lowest rounded-3xl border border-outline-variant/5 relative overflow-hidden group transition-all duration-500 hover:shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
        ...
        {/** Right side */}
        <div className="flex flex-col w-full md:max-w-1/4 items-end gap-5">
