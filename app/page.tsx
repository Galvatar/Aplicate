    ...
    <div className="flex flex-col w-full h-full font-jakarta bg-background text-on-background overflow-x-hidden">
      ...
      <div className="flex fixed w-full bg-background top-0 z-10 py-4 px-20 h-full max-h-20 border-b border-b-surface-container-high justify-between">
        <span 
          ...
          <div className="w-full h-full">
            <img src={'/logo.png'} className="aspect-square h-full" /> 
          </div>
        ...
        <div className="flex gap-8 tracking-tight text-lg font-medium items-center">
          <button className={`h-fit ${pathname === '/' ? 'font-extrabold text-primary border-b-3 border-primary' : 'hover:text-on-surface-variant'} transition-colors`}>
            Features
          </button>
          <button className={`h-fit ${pathname === '/pricing' ? 'font-extrabold text-primary border-b-3 border-primary' : 'hover:text-on-surface-variant'} transition-colors`}>
            Pricing
          </button>
          <button className={`h-fit ${pathname === '/about' ? 'font-extrabold text-primary border-b-3 border-primary' : 'hover:text-on-surface-variant'} transition-colors`}>
            About
          </button>
        </div>
      ...
      <div className="flex relative flex-col items-center ">
        ...
        >
          ...
          {/** Feature Pill Badge */}
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface-container-high border border-surface-container-highest text-xs font-medium tracking-wide text-primary">
            <span className="flex h-2 w-2 rounded-full bg-primary animate-pulse" />
            100% Frictionless Tracking
          </motion.div>

          {/** Main Title Header */}
          <motion.h1 variants={fadeInUp} className="mt-6 font-extrabold text-5xl md:text-6xl tracking-tight leading-[1.15] max-w-3xl text-on-background">
          ...
          <motion.h2 variants={fadeInUp} className="mt-6 max-w-2xl text-lg md:text-xl text-on-surface-variant font-medium leading-relaxed">
            The seamless job application tracker built for job hunters. Free forever core features, zero spreadsheet chaos, and absolutely no account required to start.
          </motion.h2>

          {/** Core Call-To-Action (CTA) */}
          <motion.div variants={fadeInUp} className="flex flex-col items-center gap-3 mt-10 w-full">
            <button 
              ...
              Launch Your Board
              <svg className="group-hover:translate-x-1.5 transition-transform duration-300" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/** Clutter-free */}
            <motion.div variants={fadeInUp} className="flex flex-col justify-between bg-surface-container-low p-8 rounded-xl border border-surface-container-high">
              <div className="flex flex-col gap-3">
                <div className="w-fit p-2 bg-primary-container/30 text-primary rounded-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M666-360q33 2 65.5-3.5T794-382q-21 131-121 216.5T440-80q-75 0-140.5-28.5t-114-77q-48.5-48.5-77-114T80-440q0-133 85.5-233T382-794q-13 30-18.5 62.5T360-666q-72 25-116 87t-44 139q0 100 70 170t170 70q77 0 139-44t87-116Zm14-560q100 0 170 70t70 170q0 100-70 170t-170 70q-100 0-170-70t-70-170q0-100 70-170t170-70Zm0 360q50 0 85-35t35-85q0-50-35-85t-85-35q-50 0-85 35t-35 85q0 50 35 85t85 35Zm0-120ZM433-433Z"/>
                  </svg>
                </div>
                <h1 className="font-bold text-2xl">
                  Clutter-Free Tracking
                </h1>
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  Say goodbye to messy spreadsheets. Experience a streamlined, distraction-free Kanban workspace built to keep you focused on what matters: getting that job offer.
                </p>
              </div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col justify-between bg-surface-container-low p-8 rounded-xl border border-surface-container-high">
              <div className="flex flex-col gap-3">
                ...
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  Already tracking elsewhere? Don't start from scratch. Upload your existing job search data via CSV file, and Aplicate will instantly populate your board in seconds.
                </p>
              </div>
              <div className="flex gap-2 items-center border border-dashed border-surface-container-highest p-4 bg-surface-container-lowest rounded-lg mt-8">
                <span className="text-xs font-mono text-on-surface-variant/60">my_tracker.csv</span>
                <div className="flex-1 h-px bg-dashed bg-surface-container-highest mx-2" />
                <span className="px-3 py-1 bg-primary/10 text-primary text-xs rounded-full font-bold">Imported ✓</span>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/** Analytics */}
            <motion.div variants={fadeInUp} className="flex flex-col justify-between bg-surface-container-low p-8 rounded-xl border border-surface-container-high md:col-span-1">
              <div className="flex flex-col gap-3">
                <div className="w-fit p-2 bg-secondary-container/70 text-on-secondary-container rounded-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-280h80v-200h-80v200Zm320 0h80v-400h-80v400Zm-160 0h80v-120h-80v120Zm0-200h80v-80h-80v80ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z"/>
                  </svg>
                </div>
                <h1 className="font-bold text-2xl">
                  Visual Progress
                ...
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  Turn your job hunt into a data pipeline. Track conversion rates from applied to offered, and instantly see where your pipeline is strongest.
                </p>
              </div>
            ...
            {/** Gmail integration */}
            <motion.div variants={fadeInUp} className="flex flex-col justify-between md:flex-row gap-6 items-center bg-surface-container-low p-8 rounded-xl border border-surface-container-high md:col-span-2">
              <div className="flex flex-col w-full md:w-1/2 gap-3">
                ...
                <h1 className="font-bold text-2xl">
                  Automated Inbox Sync
                </h1>
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  Put your tracking on autopilot. Aplicate securely detects application confirmation emails in your inbox and updates your stages instantly.
                </p>
                <button 
                  onClick={() => router.replace('/home')}
                  className="flex group items-center gap-2 mt-2 text-primary text-sm rounded-full font-bold transition-all duration-500">
                  Learn how it works
                  <svg className="group-hover:translate-x-3 transition-transform duration-500" xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="currentColor"><path d="M647-440H160v-80h487L423-744l57-56 320 320-320 320-57-56 224-224Z"/>
                  </svg>
                </button>
              </div>
        ...
        >
          ...
          <p className="text-center max-w-160 text-on-surface-variant">
            Ditch the tabs, the notes, and the chaotic bookmarks. Start tracking your next big move in seconds.
          </p>
          <div className="flex items-center gap-3 mt-3">
            ...
            <span className="text-xs font-bold text-on-surface/40 mt-3">OR</span>
            <button 
              onClick={() => router.replace('/signup')}
      ...
      <div className="flex items-center bg-surface-container-lowest justify-between px-20 py-10">
        ...
        <div className="flex gap-10 font-semibold">
          <button onClick={() => router.replace('/')} className="hover:text-on-surface-variant">Privacy Policy</button>
          <button onClick={() => router.replace('/')} className="hover:text-on-surface-variant">Terms of Service</button>
          <button onClick={() => router.replace('/')} className="hover:text-on-surface-variant">Security</button>
        </div>
      </div>
    </div>
  );
